            ...
            <div className="md:col-span-5 flex flex-col items-center text-center md:items-start md:text-left">
              <ScrollReveal delay={100} direction="up">
                ...
                <div className="space-y-1.5 mb-3 sm:mb-4">
                  <p className="font-['Cinzel',serif] text-[11px] sm:text-xs tracking-[0.24em] font-semibold text-[#7F836A] uppercase">
                    The Grandia Group presents
                  </p>
                  <h1 className="font-['Cinzel',serif] text-xl sm:text-2xl md:text-3xl tracking-[0.14em] font-bold text-[#4E644D]">
                    &ldquo;FA Live Padel Society&rdquo;
                  </h1>
                  <p className="font-['Cormorant_Garamond',serif] italic text-xs sm:text-sm tracking-[0.18em] text-[#4E644D]/85 font-medium">
                    Powered by BINUS SCHOOL Semarang × Immoderma Clinic
                  </p>
                </div>

                {/* Subtle ornamental divider */}
                <div className="w-12 h-px bg-[#7F836A]/30 mx-auto md:mx-0 my-3.5" />

                {/* Instructions text as explicitly requested */}
                <p className="font-['Cormorant_Garamond',serif] text-base sm:text-lg text-[#4E644D] leading-relaxed italic max-w-sm md:max-w-md mx-auto md:mx-0">
            ...
            <div className="md:col-span-7 w-full">
              <ScrollReveal delay={200} direction="up">
                <div className="relative overflow-hidden rounded-[16px] border border-[#E0DAC9] bg-[#FAF8F1] p-5 sm:p-7 md:p-8 shadow-[0_8px_32px_rgba(78,100,77,0.06)]">
                  {/* Clean focused form header in full English */}
          ...
          <div className="max-w-xl mx-auto text-center">
            <ScrollReveal delay={100} direction="up">
              ...
              <div className="relative overflow-hidden rounded-[14px] border border-[#D5D0BF] bg-[#FAF8F2] p-6 sm:p-8 md:p-10 shadow-[0_12px_36px_rgba(46,60,46,0.1)] -rotate-1 sm:-rotate-2 transition-transform duration-300 hover:rotate-0">
                ...
                {/* Body Content: Clean Lorem Ipsum */}
